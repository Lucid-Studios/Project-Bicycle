...
(defun run-lab-gel-engrammitization
  ...
  (let* ((operator (%warm-use-sanitize-identifier (%warm-use-value operator-id "Sanctuary.ID")))
    ...
    (list
      ...
      "engram-closure.formed=true"
      "engram-closure.pre-admission-only=true"
      "engram-closure.lab-substrate-only=true"
      "engram-closure.witnessed=true"
      "engram-closure.sealed=true"
      "engram-closure.ready-for-ec-payload=true"
      "engram-closure.admits-gel=false"
      "engram-closure.admits-engram=false"
      "engram-closure.admits-memory=false"
      "engram-closure.mutates-selfgel=false"
      "engram-closure.admits-continuity=false"
      "engram-closure.grants-authority=false"
      "engram-closure.authorizes-action=false"
