...
public sealed class ProductBodyInstallServiceTests
{
    ...
    public void Install_Creates_Cold_Local_Tool_Surface_With_Receipts_And_Shims()
    {
        ...
        Assert.Contains("run-pointing cold truth", receipt.GovernanceTrace, StringComparison.Ordinal);
    ...
    public void Install_Report_Distinguishes_Command_Executable_From_Runtime_Authority()
    {
        ...
        Assert.Contains("run-pointing cold truth", markdown, StringComparison.Ordinal);
    }
    ...
    private sealed class InstallFixture : IDisposable
    {
        ...
        {
            RootPath = rootPath;
            LineRootPath = Path.Combine(rootPath, "OAN Mortalis V1.2.1");
            ParentLinePath = Path.Combine(rootPath, "OAN Mortalis V1.1.1");
        ...
        public string ParentLinePath { get; }
        ...
        public static InstallFixture Create(bool createLauncher = true)
        {
            ...
            Directory.CreateDirectory(fixture.ParentLinePath);
            ...
            File.WriteAllText(
                ...
                """
                {
                  "lineName": "OAN Mortalis V1.2.1",
                  "lineVersion": "1.2.3",
                  "posture": "current-run-pointing-cold-truth",
                  "solutionPath": "San.sln",
                  "parentLine": "OAN Mortalis V1.1.1",
                  "activeExecutableTruth": "OAN Mortalis V1.2.1",
                  "buildable": true,
