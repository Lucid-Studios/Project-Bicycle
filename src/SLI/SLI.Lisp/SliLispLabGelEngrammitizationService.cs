...
public sealed class DefaultSliLispLabGelEngrammitizationService : ISliLispLabGelEngrammitizationService
{
        ...
        DateTimeOffset timestampUtc)
    {
        ...
        return new SliLispLabGelEngrammitizationReceipt(
            ...
            EngramClosureFormed: IsTrue(telemetry, "engram-closure.formed"),
            EngramClosurePreAdmissionOnly: IsTrue(telemetry, "engram-closure.pre-admission-only"),
            EngramClosureLabSubstrateOnly: IsTrue(telemetry, "engram-closure.lab-substrate-only"),
            EngramClosureWitnessed: IsTrue(telemetry, "engram-closure.witnessed"),
            EngramClosureSealed: IsTrue(telemetry, "engram-closure.sealed"),
            EngramClosureReadyForEcPayload: IsTrue(telemetry, "engram-closure.ready-for-ec-payload"),
            EngramClosureAdmitsGel: IsTrue(telemetry, "engram-closure.admits-gel"),
            EngramClosureAdmitsEngram: IsTrue(telemetry, "engram-closure.admits-engram"),
            EngramClosureAdmitsMemory: IsTrue(telemetry, "engram-closure.admits-memory"),
            EngramClosureMutatesSelfGel: IsTrue(telemetry, "engram-closure.mutates-selfgel"),
            EngramClosureAdmitsContinuity: IsTrue(telemetry, "engram-closure.admits-continuity"),
            EngramClosureGrantsAuthority: IsTrue(telemetry, "engram-closure.grants-authority"),
            EngramClosureAuthorizesAction: IsTrue(telemetry, "engram-closure.authorizes-action"),
