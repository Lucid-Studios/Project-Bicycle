...
public sealed class GapCrossingArticulationBoundaryValidationTests
{
    ...
    public void Build_Posture_Records_Gap_Crossing_As_V1317_Cell()
    {
        ...
        Assert.Contains(notes, note => note.Contains("V1.3.17 opens cme.gap-crossing-articulation-boundary", StringComparison.Ordinal));
        Assert.Contains(notes, note => note.Contains("cold Shared Prime pressure may approach unbound high-energy articulation surfaces", StringComparison.Ordinal));
    }
