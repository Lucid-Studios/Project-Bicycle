...
public sealed class DefaultProductBodyInstallService : IProductBodyInstallService
{
        ...
        DateTimeOffset timestampUtc)
    {
        ...
        var receipt = CreateReceipt(
            ...
            "Local Sanctuary install created a cold build tool surface. The installed launcher can execute verification and refusal commands while run-pointing cold truth remains anchored to the V1.2.1 line root; activation remains refused.",
            lineRootPath,
            installRootPath,
            productSourceRootPath,
            productInstallRootPath,
