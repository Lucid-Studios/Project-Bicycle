...
public sealed class SharedPrimeRealityPressureEcologyBoundaryValidationTests
{
    ...
    public void Build_Posture_Records_Shared_Prime_Pressure_Ecology_As_V1316_Cell()
    {
        ...
        Assert.Contains(notes, note => note.Contains("V1.3.16 opens cme.shared-prime-reality-pressure-ecology-boundary", StringComparison.Ordinal));
        Assert.Contains(notes, note => note.Contains("pressure revelation as pressure authority", StringComparison.Ordinal));
    }
